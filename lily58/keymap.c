...
[_QWERTY] = LAYOUT( \
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_DEL,    KC_LEAD, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LEAD,
...
[_LOWER]= LAYOUT( \
    ...
    LCTL_T(KC_BSPC),  KC_4,     KC_5,     KC_6,     KC_MINS,  KC_PLUS,              KC_PIPE,  KC_UNDS,  KC_PLUS,  KC_LCBR,  KC_RCBR,   KC_GRV,
    _______,  KC_7,     KC_8,     KC_9,     KC_0,     KC_DOT,    KC_ENT ,  _______, KC_BSLS,  KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,   KC_TILD,
...
[_ADJUST] = LAYOUT( \
    _______,  _______,  _______,  _______,  _______,  _______,                      _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  KC_MPLY,  KC_VOLU,  KC_MSTP,  _______,                      _______,  _______,  _______,  KC_LPRN,  KC_RPRN,  _______,
    _______,  _______,  KC_MPRV,  KC_VOLD,  KC_MNXT,  DF(_GAME),                    _______,  _______,  _______,  KC_LCBR,  KC_RCBR,  _______,
    _______,  _______,  _______,  KC_MUTE,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_LBRC,  KC_RBRC,  _______,
                                  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______
),
};
